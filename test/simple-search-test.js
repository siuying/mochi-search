  ...
  describe("#search", () => {
    it("should search chinese (fetch document)", (done) => {
      const search = new SimpleSearch(":memory:", (error, search) => {
        ...
        search.search({query: "中文", fetchIdOnly: false}, (error, result) => {
    ...
    it("should search chinese (fetch id only)", (done) => {
      const search = new SimpleSearch(":memory:", (error, search) => {
        ...
        search.search({query: "中文", fetchIdOnly: true}, (error, result) => {
          debug("result", error, result)
          expect(error).to.not.exist;
